...
> 当前版本速览：sw 0.4.21-rc3 · zh 0.1.14 · gzh hammer.24 · media dev36 · pipeline 9R34（发版打 `vYYYY.MM.DD-<档号>` tag；编排器第 0 步自动检查更新）
...
| 🔨 [gzh-design](./skills/gzh-design) | 排版引擎：Markdown → 公众号精致 HTML（**基于 isjiamu 版增强，见来源与致谢**） | ✅ 零依赖 | hammer.24 |
