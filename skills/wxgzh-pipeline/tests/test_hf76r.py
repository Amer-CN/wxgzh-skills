...
def test_obs304_ledger_count_command():
    ...
    # 77T 更新:OBS-349/350/351/352 登记后 119..352 = 234 个编号(76Y-R/77K 起计数实测为准)
    # 77U 更新:OBS-353/354/355 登记后 119..355 = 237 个编号(76Y-R/77K 起计数实测为准)
    # 77V 更新:OBS-356 登记后 119..356 = 238 个编号(76Y-R/77K 起计数实测为准)
    # 77W 更新:OBS-357/358/359 登记后 119..359 = 241 个编号(76Y-R/77K 起计数实测为准)
    # 77X 更新:OBS-360..365 登记后 119..365 = 247 个编号(76Y-R/77K 起计数实测为准)
    ...
    # 77AC 更新:OBS-380 登记后 119..380 = 262 个编号(76Y-R/77K 起计数实测为准)
    # 77AD 更新:OBS-381 登记后 119..381 = 263 个编号(76Y-R/77K 起计数实测为准)
    # 77AE 更新:OBS-382 登记后 119..382 = 264 个编号(76Y-R/77K 起计数实测为准)
    # 77AF 更新:OBS-383 登记后 119..383 = 265 个编号(76Y-R/77K 起计数实测为准)
    ...
    # 77AK 更新:OBS-388 登记后 119..388 = 270 个编号(76Y-R/77K 起计数实测为准)
    # 77AL 更新:OBS-389 登记后 119..389 = 271 个编号(76Y-R/77K 起计数实测为准)
    assert n == 271, f"唯一编号实测 {n} != 271"
    # 区间连续无缺号
    assert set(range(119, 390)) <= nums, "119..389 区间有缺号"
