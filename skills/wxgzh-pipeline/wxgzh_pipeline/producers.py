...
def _agent_validator_args(stage: str, ctx, sd: Path) -> list[tuple[str, str, list]]:
    ...
    if stage == "zh_human_writing":
        ...
        return [
            # 77A/OBS-309:半角引号机械归一(中文语境成对转全角,单边留 WARNING 不硬改)
            ("zh-human-writing", "scripts/normalize_quotes.py",
    ...
    try:
        ...
        if not approval_file.is_file():
            return [], {
                ...
                "approval_contract_rule": APPROVAL_CONTRACT_RULE,
