...
def run_tests(errors):
    ...
    try:
        ...
        if result.returncode != 0:
            ...
            # Verify 92/92(77L:77L-01/02/03 新增,89 → 92)
            if "92" not in result.stdout:
                errors.append("Test suite passed but expected 92 tests")
